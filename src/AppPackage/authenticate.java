    ...
    float score=0;
      try{ 
         ...
         String sql2="select * from press_time";
          ...
          while(rs.next()){
             ...
             { 
               ...
               //JOptionPane.showMessageDialog(null,i1.get(0));
             }  
          }
        ...
        for(int i=0;i<num;i++)
        {
          ...
          n=((float) Math.pow(n1+n2,2))/10; 
          sdik[i]=(float) Math.sqrt((m-n)/10);
          //JOptionPane.showMessageDialog(null,sdp[i]);
        ...
        sdt=(float) Math.sqrt((m-n)/10);
        //Calculating Difference
        for(int i=0;i<num;i++)
        {
          Dp[i]=Math.abs(PT.get(i)-meanp[i]);
          Dik[i]=Math.abs(IKT.get(i)-meanik[i]);
        }
        Dt=Math.abs(TT-meant);
       //Calculating Score 
       for(int i=0;i<num;i++)
       {
         scorep[i]=(float)(Dp[i]/(2*sdp[i]));
         JOptionPane.showMessageDialog(null,scorep[i]);
         scoreik[i]=(float)(Dik[i]/(2*sdik[i]));
         JOptionPane.showMessageDialog(null,scoreik[i]);
       }
       scoret=(float)(Dt/(2*sdt));
       JOptionPane.showMessageDialog(null,scoret);
       for(int i=0;i<num;i++)
       {
       ...
       JOptionPane.showMessageDialog(null,score); 
         ...
         JOptionPane.showMessageDialog(null,"In authen."); 
        }
      if(score<=1)
        return true;
      else 
